---
name: ecc-promote
description: プロジェクトスコープの instinct をグローバルスコープに昇格させる
command: true
---
...
```bash
/ecc-promote                      # Auto-detect promotion candidates
/ecc-promote --dry-run            # Preview auto-promotion candidates
/ecc-promote --force              # Promote all qualified candidates without prompt
/ecc-promote grep-before-edit     # Promote one specific instinct from current project
```
