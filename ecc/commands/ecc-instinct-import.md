...
description: ファイルまたは URL からプロジェクト/グローバルスコープに instinct をインポートする
command: true
---
...
/ecc-instinct-import team-instincts.yaml --dry-run
/ecc-instinct-import team-instincts.yaml --scope global --force
```
