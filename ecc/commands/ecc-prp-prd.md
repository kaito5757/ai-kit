---
description: "対話型 PRD ジェネレーター — 問題ドリブン・仮説駆動のプロダクト仕様を対話しながら作成"
...
Run: `/ecc-prp-plan .claude/PRPs/prds/{name}.prd.md`
...
- Use `/ecc-prp-plan` to create implementation plans from PRD phases
- Use `/ecc-plan` for simpler planning without PRD structure
