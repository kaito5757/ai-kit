---
description: "セッションから再利用可能なパターンを抽出し、保存前に品質を自己評価した上で、適切な保存先（Global / Project）を判定する"
---

# /ecc-learn-eval - Extract, Evaluate, then Save

Extends `/ecc-learn` with a quality gate, save-location decision, and knowledge-placement awareness before writing any skill file.
