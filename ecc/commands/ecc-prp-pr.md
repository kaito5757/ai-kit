---
description: "未 push コミットのある現在のブランチから GitHub PR を作成 — テンプレート検出、変更解析、push まで自動化"
...
| Clean working directory | No uncommitted changes | Warn: "You have uncommitted changes. Commit or stash first. Use `/ecc-prp-commit` to commit." |
